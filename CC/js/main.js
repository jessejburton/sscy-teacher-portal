(function($){
    $(function(){
        ...
        $(document).on("click", ".button-action", function(){
            var comment = $(".agenda__item-action.template").clone(false);
        ...
        // ADD NEW DECISION
        $(document).on("click", ".button-decision", function(){
            var comment = $(".agenda__item-decision.template").clone(false);
            comment.find(".agenda__item-comment--text").html($(this).parents(".agenda__item").find(".agenda__item-textarea").val());
            comment.removeClass("template");
        ...
        // ADD NEW INCAMERA
        $(document).on("click", ".button-incamera", function(){
            var comment = $(".agenda__item-incamera.template").clone(false);
            comment.find(".agenda__item-comment--text").html($(this).parents(".agenda__item").find(".agenda__item-textarea").val());
            comment.removeClass("template");

            $(this).parents(".agenda__item").find(".agenda__item-name").addClass("incamera");
            $(this).parents(".agenda__item").find(".agenda__item-add").before(comment);
